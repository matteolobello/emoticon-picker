...
public class EmoticonAdapter extends RecyclerView.Adapter<EmoticonAdapter.ViewHolder> {
    ...
    public EmoticonAdapter(Context context, List<String> emojis) {
        this.emojis = emojis;
                            ...
                            new Thread(new Runnable() {
                                ...
                                public void run() {
                                    Wearable.MessageApi.sendMessage(googleApiClient, node.getId(),
                                            "/emoticon/clicked", emojis.get(position).getBytes()).await();
                                }
                            }).start();
                        }
                    }
    ...
    static class ViewHolder extends RecyclerView.ViewHolder {
        ...
        ViewHolder(View emoji) {
            super(emoji);
            emojiTextView = (TextView) emoji.findViewById(R.id.emoticon);
        }
    }
}
