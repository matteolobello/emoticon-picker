...
import emojipicker.gui.EmoticonPickerGui;
...
public class EmoticonPicker {
     ...
     */
    private static EmoticonPickerGui frame;
        ...
        EventQueue.invokeLater(new Runnable() {
            public void run() {
                try {
                    ...
                    Logger.getLogger(EmoticonPicker.class.getName()).log(Level.SEVERE, null, ex);
                }
            }
        });
    ...
    private static void setupSystemTray() {
         if (SystemTray.isSupported()) {
             try {
                 ...
                 TrayIcon trayIcon = new TrayIcon(image, "EmoticonPicker", popup);
    ...
    private static class ListenThread extends Thread {
        ...
        private void listen() {
            try {
                ...
                if (msgReceived.contains("Connected to:")) {                    
                    ...
                    handleNewReceivedEmoticon(msgReceived);
                }
        ...
        /**
         * Handle a new received Emoticon
         * 
         * @param msgReceived
         ...
         */
        private void handleNewReceivedEmoticon(String msgReceived) 
        ...
        /**
         * Copy the Emoticon to clipboard
         * 
         * @param text
         * @throws UnsupportedFlavorException
         * @throws IOException 
